...
**分赃顺序**：有谋士在场则赃款加 200 万 → 按还留在场上的人物数量平均分配
（向下取整）→ 每个分到钱的人物向唯一的司机付 100 万 → 唯一的恶棍从唯一的暴徒
处夺取 200 万 → 赃物牌上标出的奖励角色额外获得 100 万。

**胜利**：分赃后现金达到 2000 万立即获胜；否则第 8 回合结束时现金最多者获胜，并列共同获胜。

**常用指令**（都以「百万美金」开头）：菜单、创建、加入、退出房间、关闭房间、
开始、状态、转账、退出、准备、取消准备、使用威胁牌、强制抢劫、帮助。
"""
